...
The statistical language, R ( __ADD REFERENCE__), was used to for data prepration, analyses, and the development of this document. R is a free open source language with a large library of packages (extensions of the base language) for data analysis.
...
3. Hopefully the document will compile correctly. If the document does not compile correctly, try to interpret and correct for the error message returned. If you cannot interprete the error message, please [open a new issue on the GitHub respository for this document](https://github.com/zsmith27/bibi_baseline/issues) and I will try to help you resolve the issue.
