...
Hydrologic unit codes (HUCs) 8, 10, and 12 were already present in the Chessie BIBI data. HUC4 (`huc4`) and HUC6 (`huc6`) are extracted from the HUC8 column (`huc8`).
```{r}
bibi.df <- bibi.df %>% 
...
Assigning the appropriate catchment is more difficult than assigning lower resolution HUCs.
```{r}
