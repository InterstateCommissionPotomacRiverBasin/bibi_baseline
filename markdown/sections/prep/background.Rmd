...
The twelve bioregions may be slightly more specific and sensitive to geographic differences but summarizing and comparing results across the basin is easier with the regional indices. Smith et al. (2017) ( __ADD REFERENCE__ ) recommend the regional family-level indices for CBP reporting purposes; the family-level bioregion indices represent a valid alternative or could be used in combination with the family-level regional indices to evaluate stream condition locally within the Chesapeake Bay basin.

One of the goals in the 2014 Chesapeake Bay Agreement ( __ADD REFERENCE__) is to “Improve health and function of ten percent of stream miles above the 2008 baseline for the watershed.” The Chesapeake Bay Program (CBP) selected the Chessie BIBI as its biological indicator of stream health. It will use the index to evaluate and report progress improving stream communities across the Chesapeake watershed. A 2008 baseline for the Chessie BIBI still needs to be established.  On April 5th, a morning workshop scheduled for the (2018 Association of Mid-Atlantic Aquatic Biologists (AMAAB) conference)[http://www.amaab.org/] at Cacapon Resort State Park will summarize the recent BIBI index update and refinement.  Speakers will explain why CBP selected the BIBI as its stream health indicator, present results illustrating BIBI responses to nutrient enrichment, flow alteration, and land use, and lay out the technical challenges of developing a 2008 baseline.  The workshop will be open to as many as 40 AMAAB participants. 

A second, smaller workshop will convene immediately following the AMAAB workshop and extend into the next day.  It will resolve the 2008 baseline technical challenges and establish the 2008 baseline.

__This document describes the materials prepared for the upcoming workshop and how they were created…__
